...
const Journey = () => {
  return (
    <div className='px-[10%] grid grid-cols-2 gap-10 py-20 mobile:grid-cols-1 place-items-center'>
    ...
    <div className='grid grid-cols-3 gap-5 py-13 my-20 mobile:grid-cols-1 mobile:text-center' >
        <Informations />
    </div>
    </div>
    <div className='border border-solid border-grey-15  ml-auto rounded-3xl mobile:hidden aspect-auto h-fit'>
