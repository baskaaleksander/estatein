...
const Values = () => {
  return (
    <div className="px-[10%] py-20 flex navbar:flex-col">
        <div className="mr-20">
        ...
        <div className="grid grid-cols-2 gap-8 p-14 bg-grey-08 border border-solid border-grey-15 rounded-xl shadow-card text-white-0 navbar:mt-20 mobile:grid-cols-1">
            ...
            <div className="pt-8 flex items-center mobile:flex-col" >
